...
export default function TeamsPage() {
  ...
  const save = async (event: FormEvent) => {
    ...
    try {
      ...
      if (editingTeam) {
        await api(`/teams/${editingTeam.id}`, { method: 'PATCH', body: { name: name.trim(), leadId: leadId || null, memberIds: selected, createChat, acceptsTickets } })
