...
const NAV_ICON_MAP: Record<string, string> = {
  ...
  '/msp': 'msp', '/grants': 'access', '/ai-agent': 'ai', '/ai-workers': 'ai', '/ai-governance': 'ai', '/ai-opportunities': 'ai', '/ai-playbooks': 'ai', '/integrations': 'integrations',
  ...
  const sections: NavSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { to: '/ai-workers', label: 'AI workers', show: can('ai_agent.read') },
        { to: '/ai-governance', label: 'AI governance', show: can('ai_agent.read') },
        { to: '/ai-opportunities', label: 'AI opportunities', show: can('ai_agent.read') },
        { to: '/ai-playbooks', label: 'AI playbooks', show: can('ai_agent.read') },
